...
func CreateAuthorizationPayment(authorizationRequestDto dto.AuthorizationRequest,
...
func CreateSuccessivePayment(successiveRequestDto dto.SuccessiveRequest,
